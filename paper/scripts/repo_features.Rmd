...
```{r gender}
join_tbl(
  get_table(ds_analysis, table_gender_authors) %>% rename(commit_authors_female = female,
...
rm(abstract_top_topics, article_data, df, dtm, lda, topics, topics_specialized, iso_to_iso, journal_to_iso_abbrev)
```
