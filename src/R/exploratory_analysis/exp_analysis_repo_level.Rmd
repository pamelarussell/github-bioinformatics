...
table_list <- c("language_list_by_repo", "num_languages_by_repo", "lines_of_code_by_repo", 
                "project_duration_by_repo", "num_fork_events_by_repo", "num_watch_events_by_repo", 
...
qplot(repo_level_data$num_fork_events,
      geom = "histogram",
      main = "Histogram of number of fork events",
      xlab = "Number of fork events",
      ylab = "Number of repos",
      fill = I("darkmagenta")) +
  theme(plot.title = element_text(size = 24),
        axis.title.x = element_text(size = 16),
...
qplot(repo_level_data$num_watch_events,
      geom = "histogram",
      main = "Histogram of number of watch events",
      xlab = "Number of watch events",
      ylab = "Number of repos",
      fill = I("darkmagenta")) +
  theme(plot.title = element_text(size = 24),
        axis.title.x = element_text(size = 16),
