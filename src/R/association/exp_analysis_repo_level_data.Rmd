---
title: 'Exploratory analysis: repo level data'
...
```{r cache = T}
# Load all the data from BigQuery and do a full repo_level_data by repo name
proj <- "github-bioinformatics-157418"
dataset <- "test_repos_analysis_results"
...
for(table in table_list) {
  table_data <- list_tabledata(project = proj, dataset = dataset, table = table)
